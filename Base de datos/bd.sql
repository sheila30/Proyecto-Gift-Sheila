...
PROCEDURE INSERT_RESPUESTA(P_RESPUESTA RESPUESTAS.RESPUESTA%TYPE,
                           P_ACERTADA RESPUESTAS.RESPUESTA%TYPE,
                           P_IDPREG RESPUESTA.PREGUNTA_ID_CAT%TYPE,
                           P_IDRES OUT NUMBER);
...
PROCEDURE UPDATE_PREGUNTA (P_IDPREG IN PREGUNTAS.ID_PREG%TYPE, 
                           ...
                           P_IDCATPREG IN CATEGORIA_ID_PREG%TYPE);

PROCEDURE UPDATE_RESPUESTA (P_IDRESP IN REPUESTAS.ID_RESP%TYPE, 
                           P_RESPUESTA IN RESPUESTAS.RESPUESTA%TYPE, 
                           P_ACERTADA IN REPUESTAS.ACERTADA%TYPE);
...
PROCEDURE INSERT_RESPUESTA(P_RESPUESTA IN RESPUESTAS.RESPUESTA%TYPE,
                           P_ACERTADA IN RESPUESTAS.RESPUESTA%TYPE,
                           P_IDPREG IN RESPUESTA.PREGUNTA_ID_CAT%TYPE,
                           P_IDRES OUT NUMBER)
...
PROCEDURE UPDATE_PREGUNTA (P_IDPREG PREGUNTAS.ID_PREG%TYPE, 
                           P_ENUNCIADO PREGUNTAS.ENUNCIADO%TYPE, 
                           P_IDCATPREG CATEGORIA_ID_PREG%TYPE)
...
PROCEDURE UPDATE_RESPUESTA (P_IDRESP REPUESTAS.ID_RESP%TYPE, 
                           P_RESPUESTA RESPUESTAS.RESPUESTA%TYPE, 
                           P_ACERTADA REPUESTAS.ACERTADA%TYPE)

IS
BEGIN
UPDATE RESPUESTAS
SET RESPUESTA = P_RESPUESTA, ACERTADA = P_ACERTADA
WHERE IDRESP = P_IDRESP;
